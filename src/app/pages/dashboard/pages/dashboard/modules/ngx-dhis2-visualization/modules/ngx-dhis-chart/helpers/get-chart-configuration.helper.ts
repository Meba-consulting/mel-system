...
export function getChartConfiguration(
  ...
  // console.log('visualizationSettings', JSON.stringify(visualizationSettings));
  const chartType =
    customChartType !== ''
  ...
  return {
    ...
    reverseLegend: false,
    showLabels: true,
    plotBandsByLegend: getPlotBands(legendSets, visualizationSettings),
...
function getPlotBands(legendsSets, visualizationSettings) {
  const legendClasses = visualizationSettings.legendSet
    ? visualizationSettings.legendSet.legends
    : [];
