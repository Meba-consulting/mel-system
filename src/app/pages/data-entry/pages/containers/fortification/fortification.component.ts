...
import { loadDataEntryFlow, loadProgramMetadata } from '../../../store/actions';
import { Observable } from 'rxjs';
import {
  getDataEntryFormsByOuId,
  getProgramMetadataById,
  getProgramStageById
...
@Component({
  selector: 'app-fortification',
  templateUrl: './fortification.component.html',
  styleUrls: ['./fortification.component.css']
})
export class FortificationComponent implements OnInit {
  ...
  constructor(
    ...
    // this.store.dispatch(loadProgramMetadata({ programId: 'IzEQE6HnpoC' }));
    this.currentUser$ = this.store.select(getCurrentUser);
    this.programMetadata$ = this.store.select(getProgramMetadataById, {
      id: 'IzEQE6HnpoC'
    });

    imsData['currentProgramId'] = 'IzEQE6HnpoC';
