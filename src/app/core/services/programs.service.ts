...
export class ProgramsService {
  ...
  loadPrograms(): Observable<any> {
    return this.httpClient.get(
      'programs.json?paging=false&fields=id,name,programType,organisationUnits,userGroupAccesses,incidentDateLabel,attributeValues,trackedEntityType[id,name,trackedEntityTypeAttributes[id,name,mandatory,trackedEntityAttribute[id,name,valueType,optionSet[id,name,valueType,options[id,name,valueType]]]]],userGroupAccesses[*],programIndicators[id,name,expression],name,dataEntryForm[id,name,htmlCode],programTrackedEntityAttributes[id,name,code,valueType,trackedEntityAttribute[id,name,optionSet[id,name,valueType,options[id,name,valueType]]]],programStages[repeatable,sortOrder,programStageSections[id,name,description,sortOrder,dataElements[id,name,optionSet[id,name,valueType,options[id,name,valueType]]]],userGroupAccesses[*],id,name,dataEntryForm[id,htmlCode],programStageDataElements[displayInReports,compulsory,dataElement[id,name,code,valueType,optionSet[id,name,options[id,name,code]]]]]'
    );
  }
}
